...
I'm a Pythonista (🐍) and sometimes Gopher (🐹) who creates programs and scripts to solve problems in my life. (I have also dabbled in video game development) My ultimate achievement is the ELDonationTracker below, which is a utility for folks raising money via the Extra Life charity. I also participate in [Advent of Code](https://www.adventofcode.com).
